package com.codewizard.miter.codingwizard_adpater;
...
import com.codewizard.miter.codingwizard_adpater.base.AbsMultiSelectAdapter;
import com.codewizard.miter.codingwizard_adpater.base.MediaEntryViewHolder;
import com.codewizard.miter.coding_wizard_dialogs.ClearSmartPlaylistDialog;
...
import com.codewizard.miter.coding_wizard_helper.menu.PlaylistMenuHelper;
import com.codewizard.miter.coding_wizard_helper.menu.SongsMenuHelper;
...
import com.codewizard.miter.Models.smartplaylist.AbsSmartPlaylist;
import com.codewizard.miter.Models.smartplaylist.LastAddedPlaylist;
    ...
    private static class SavePlaylistsAsyncTask extends WeakContextAsyncTask<List<Playlist>, String, String> {
        ...
        protected String doInBackground(List<Playlist>... params) {
            ...
            for (Playlist playlist : params[0]) {
                try {
                    dir = PlaylistsUtil.savePlaylist(Coding_wizard_Config_file.getInstance().getApplicationContext(), playlist).getParent();
                    successes++;
                } catch (IOException e) {
                    failures++;
                    e.printStackTrace();
            ...
            return failures == 0
                    ? String.format(Coding_wizard_Config_file.getInstance().getApplicationContext().getString(R.string.saved_x_playlists_to_x), successes, dir)
                    : String.format(Coding_wizard_Config_file.getInstance().getApplicationContext().getString(R.string.saved_x_playlists_to_x_failed_to_save_x), successes, dir, failures);
        }
