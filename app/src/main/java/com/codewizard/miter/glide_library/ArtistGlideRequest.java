...
import com.codewizard.miter.glide_library.artistimage.AlbumCover;
import com.codewizard.miter.glide_library.artistimage.ArtistImage;
import com.codewizard.miter.glide_library.palette.BitmapPaletteTranscoder;
...
import com.codewizard.miter.coding_wizard_utils.ArtistSignatureUtil;
...
public class ArtistGlideRequest {
    ...
    public static DrawableTypeRequest createBaseRequest(RequestManager requestManager, Artist artist, boolean noCustomImage) {
        boolean hasCustomImage = CustomArtistImageUtil.getInstance(Coding_wizard_Config_file.getInstance()).hasCustomArtistImage(artist);
    ...
    private static Key createSignature(Artist artist) {
        return ArtistSignatureUtil.getInstance(Coding_wizard_Config_file.getInstance()).getArtistSignature(artist.getName());
    }
}
